        ...
        <div className="layout flex flex-col items-center justify-center pt-16 pb-4 px-20">
            ...
            <div className="input-forms">
                ...
                />
                        ...
                        <FormControlLabel control={<input type="checkbox" />} label="Se souvenir de moi" labelPlacement="end" className="label pl-2"   sx={{ gap: '8px', marginLeft: '4px' , alignItems : 'center' }} />
                                            <NavLink to={"/auth/forgotmdp"} className="label">
                                                <p className="link" style={{color: 'purple', fontWeight : '600'}}>Mot de passe oublié ?</p> 
                                            </NavLink>
                        </div>
            ...
            <div>
                ...
                <p className="">Besoin d'un compte Key predict ?</p>
